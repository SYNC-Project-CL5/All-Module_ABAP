class ZCL_ZEA_BATCH_01_MPC definition
  public
...
CLASS ZCL_ZEA_BATCH_01_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZEA_BATCH_SRV_01' ).
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20240603021834'.                  "#EC NOTEXT
