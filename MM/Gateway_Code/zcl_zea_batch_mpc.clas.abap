class ZCL_ZEA_BATCH_MPC definition
  public
...
CLASS ZCL_ZEA_BATCH_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZEA_BATCH_SRV' ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZEA_MMS220'
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20240531093617'.                  "#EC NOTEXT
