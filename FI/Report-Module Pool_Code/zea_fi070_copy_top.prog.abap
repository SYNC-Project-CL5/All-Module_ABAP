...
TABLES : ZEA_FIT800 ,  "Vendor 원장 테이블
         ...
         ZEA_TCURR,    "환율테이블
         ZEA_MMT170,   "송장검증 Item
         ZEA_MMT160.   "송장검증 Header

DATA : GT_MMT170 LIKE TABLE OF ZEA_MMT170,
       GS_MMT170 TYPE ZEA_MMT170.
...
DATA : POST_RAT TYPE ZEA_TCURR-UKURS,

       LV_TOTAL TYPE P LENGTH 9 DECIMALS 5.

DATA: BEGIN OF LS_TCURR.
