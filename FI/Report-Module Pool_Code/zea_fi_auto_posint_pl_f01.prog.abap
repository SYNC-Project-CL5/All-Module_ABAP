...
*&---------------------------------------------------------------------*
  ...
  INSERT ZEA_BSEG FROM GS_BSEG.
  _MC_ITEM '4' '50' '410003' '제품국내매출액' '401760' '10003' ''. " 대변
  INSERT ZEA_BSEG FROM GS_BSEG.
...
*&---------------------------------------------------------------------*
  ...
  INSERT ZEA_BSEG FROM GS_BSEG.
  _MC_ITEM '4' '50' '410004' '제품국내매출액' '374976' '10004' ''. " 대변
  INSERT ZEA_BSEG FROM GS_BSEG.
  ...
  INSERT ZEA_BSEG FROM GS_BSEG.
  _MC_ITEM '4' '50' '410004' '제품국내매출액' '374976' '10004' '30000010'. " 대변
  INSERT ZEA_BSEG FROM GS_BSEG.
...
*&---------------------------------------------------------------------*
  ...
  INSERT ZEA_BSEG FROM GS_BSEG.
  _MC_ITEM '4' '50' '410005' '제품국내매출액' '428544' '10005' '30000011'. " 대변
  INSERT ZEA_BSEG FROM GS_BSEG.
...
*&---------------------------------------------------------------------*
  ...
  INSERT ZEA_BSEG FROM GS_BSEG.
  _MC_ITEM '4' '50' '410006' '제품국내매출액' '707072' '10006' ''. " 대변
  INSERT ZEA_BSEG FROM GS_BSEG.
...
*&---------------------------------------------------------------------*
  ...
  INSERT ZEA_BSEG FROM GS_BSEG.
  _MC_ITEM '4' '50' '410007' '제품국내매출액' '374976' '10007' ''. " 대변
  INSERT ZEA_BSEG FROM GS_BSEG.
...
*&---------------------------------------------------------------------*
  ...
  INSERT ZEA_BSEG FROM GS_BSEG.
  _MC_ITEM '4' '50' '410008' '제품국내매출액' '374976' '10008' ''. " 대변
  INSERT ZEA_BSEG FROM GS_BSEG.
...
*&---------------------------------------------------------------------*
  ...
  INSERT ZEA_BSEG FROM GS_BSEG.
  _MC_ITEM '4' '50' '410009' '제품국내매출액' '482112' '10009' ''. " 대변
  INSERT ZEA_BSEG FROM GS_BSEG.
