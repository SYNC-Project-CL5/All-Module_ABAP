class ZCL_ZEA_MM020_MPC definition
  public
...
TT_ZEA_MM010 type standard table of TS_ZEA_MM010 .
  ...
  constants GC_ZEA_MM010 type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ZEA_MM010' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZEA_MM020_MPC=============CP' ##NO_TEXT.

  methods DEFINE_ZEA_MM010
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
ENDCLASS.
...
CLASS ZCL_ZEA_MM020_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZEA_MM020_SRV' ).

define_zea_mm010( ).
  endmethod.


  method DEFINE_ZEA_MM010.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'ZEA_MM010' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZEA_MM020_MPC=>TS_ZEA_MM010' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ZEA_MM010Set' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20240528062458'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'ZEA_MM010'.                            "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Scode'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'ZEA_MM010'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
