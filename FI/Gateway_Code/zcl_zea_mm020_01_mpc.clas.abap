class ZCL_ZEA_MM020_01_MPC definition
  public
...
CLASS ZCL_ZEA_MM020_01_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZEA_MM020_SRV_01' ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZEA_MM010'
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20240603020953'.                  "#EC NOTEXT
