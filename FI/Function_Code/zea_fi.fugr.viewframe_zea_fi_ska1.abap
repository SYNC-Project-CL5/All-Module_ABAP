*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZEA_FI_SKA1
*   generation date: 2024.05.18 at 18:23:42
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZEA_FI_SKA1         .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZEA_FI_SKA1'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZEA_FI_SKA1_EXTRACT
TOTAL = ZEA_FI_SKA1_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZEA_FI_SKA1'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZEA_FI_SKA1-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZEA_FI_SKA1_EXTRACT
TOTAL = ZEA_FI_SKA1_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZEA_FI_SKA1-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZEA_FI_SKA1'
...
TOTAL = ZEA_FI_SKA1_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZEA_FI_SKA1-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZEA_FI_SKA1-UPD_FLAG NE SPACE.
