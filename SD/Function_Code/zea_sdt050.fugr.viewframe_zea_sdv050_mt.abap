*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZEA_SDV050_MT
*   generation date: 2024.05.18 at 22:05:02
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZEA_SDV050_MT       .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZEA_SDV050_MT'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZEA_SDV050_MT_EXTRACT
TOTAL = ZEA_SDV050_MT_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZEA_SDV050_MT'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZEA_SDV050_MT-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZEA_SDV050_MT_EXTRACT
TOTAL = ZEA_SDV050_MT_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZEA_SDV050_MT-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZEA_SDV050_MT'
...
TOTAL = ZEA_SDV050_MT_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZEA_SDV050_MT-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZEA_SDV050_MT-UPD_FLAG NE SPACE.
