*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZEA_SDT050MV
*   generation date: 2024.05.13 at 19:30:33
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZEA_SDT050MV        .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZEA_SDT050MV'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZEA_SDT050MV_EXTRACT
TOTAL = ZEA_SDT050MV_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZEA_SDT050MV'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZEA_SDT050MV-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZEA_SDT050MV_EXTRACT
TOTAL = ZEA_SDT050MV_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZEA_SDT050MV-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZEA_SDT050MV'
...
TOTAL = ZEA_SDT050MV_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZEA_SDT050MV-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZEA_SDT050MV-UPD_FLAG NE SPACE.
