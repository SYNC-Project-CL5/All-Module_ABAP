...
FORM HANDLER_TOOLBAR
  ...
  DATA : LV_SBEL TYPE I,      " 전체조회
         LV_WAIT TYPE I,      " 출고 대기
         LV_OK   TYPE I,      " 출고 완료
         LV_ING  TYPE I,      " 배송중
         LV_FIN  TYPE I.      " 배송 완료
  ...
  CASE PO_SENDER.
    WHEN GO_ALV_GRID_1.
      ...
      LOOP AT GT_DISPLAY INTO GS_DISPLAY.
        ...
        CASE GS_DISPLAY-RETSU.
          WHEN '출고 대기'.
            ADD 1 TO LV_SBEL.
            ADD 1 TO LV_WAIT.
          WHEN '출고 완료'.
            IF GS_DISPLAY-DESTU EQ '배송중'.
              ADD 1 TO LV_SBEL.
              ADD 1 TO LV_OK.
              ELSEIF GS_DISPLAY-DESTU EQ '배송완료'.
               ADD 1 TO LV_SBEL.
               ADD 1 TO LV_OK.
            ENDIF.
        ENDCASE.

        CASE GS_DISPLAY-DESTU.
          WHEN '배송완료'.
            ADD 1 TO LV_FIN.
        ENDCASE.
      ENDLOOP.
...
* 버튼 추가 =>> 전체조회
      CLEAR LS_TOOLBAR.
      LS_TOOLBAR-BUTN_TYPE = 0. " 전체조회
      LS_TOOLBAR-FUNCTION = GC_SBEL.
      LS_TOOLBAR-TEXT = TEXT-L09 && ':' && LV_SBEL.
      APPEND LS_TOOLBAR TO PO_OBJECT->MT_TOOLBAR.

* 버튼 추가 =>> 출고대기
      CLEAR LS_TOOLBAR.
      LS_TOOLBAR-BUTN_TYPE = 0. " 출고대기
      LS_TOOLBAR-FUNCTION = GC_WAIT.
      LS_TOOLBAR-ICON = ICON_LED_YELLOW.
      LS_TOOLBAR-TEXT = TEXT-L10 && ':' && LV_WAIT.
      APPEND LS_TOOLBAR TO PO_OBJECT->MT_TOOLBAR.

* 버튼 추가 =>> 출고 완료
      CLEAR LS_TOOLBAR.
      LS_TOOLBAR-BUTN_TYPE = 0. " 출고 완료
      LS_TOOLBAR-FUNCTION = GC_OK.
      LS_TOOLBAR-ICON = ICON_WS_TRUCK.
      LS_TOOLBAR-TEXT = TEXT-L11 && ':' && LV_OK.
      APPEND LS_TOOLBAR TO PO_OBJECT->MT_TOOLBAR.

* 버튼 추가 =>> 배송 완료
      CLEAR LS_TOOLBAR.
      LS_TOOLBAR-BUTN_TYPE = 0. " 배송 완료
      LS_TOOLBAR-FUNCTION = GC_FIN.
      LS_TOOLBAR-ICON = ICON_DELIVERY_COMPLETE.
      LS_TOOLBAR-TEXT = TEXT-L07 && ':' && LV_FIN.
      APPEND LS_TOOLBAR TO PO_OBJECT->MT_TOOLBAR.
