...
*&---------------------------------------------------------------------*
TABLES: ZEA_SDT060, ZEA_SDT110.

CLASS LCL_EVENT_HANDLER DEFINITION DEFERRED.

CONSTANTS :  GC_SBEL    TYPE STRING VALUE 'GC_SBEL',
             GC_WAIT    TYPE STRING VALUE 'GC_WAIT',
             GC_OK      TYPE STRING VALUE 'GC_OK ',
             GC_ING     TYPE STRING VALUE 'GC_ING ',
             GC_FIN     TYPE STRING VALUE 'GC_FIN '.



DATA: GT_DATA TYPE TABLE OF ZEA_SDT060,
      GS_DATA TYPE ZEA_SDT060.
...
DATA: GT_DATA2 TYPE TABLE OF ZEA_SDT110,
      GS_DATA2 TYPE ZEA_SDT110.
