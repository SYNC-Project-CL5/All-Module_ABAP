...
* Include
INCLUDE ZEA_SD120_TOP.
INCLUDE ZEA_SD120_SCR.
INCLUDE ZEA_SD120_PBO.
INCLUDE ZEA_SD120_PAI.
INCLUDE ZEA_SD120_F01.
...
INITIALIZATION.
  ...
  LS_DYNTXT-ICON_TEXT = '판매운영계획 헤더 엑셀 양식 다운로드'.
  SSCRFIELDS-FUNCTXT_01 = LS_DYNTXT.
*  SSCRFIELDS-FUNCTXT_01 = 'BOM HEADER 엑셀 양식 다운로드'.
