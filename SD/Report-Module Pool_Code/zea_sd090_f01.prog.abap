  ...
  CASE PO_SENDER.
    WHEN GO_ALV_GRID_1.
      ...
      CASE PS_COLUMN_ID-FIELDNAME.
        ...
        WHERE PAYNR EQ GS_DISPLAY-PAYNR.
*      AND POSNR EQ GS_DISPLAY-POSNR.
    ...
    WHEN GO_ALV_GRID_2.
      READ TABLE GT_DISPLAY2 INTO GS_DISPLAY2 INDEX PS_ROW_ID-INDEX.

      IF PS_ROW_ID-ROWTYPE IS INITIAL.

        SET PARAMETER ID 'ZEA_PAYNR' FIELD GS_DISPLAY2-PAYNR.
        CALL TRANSACTION 'ZEASDA09'.
      ENDIF.
  ENDCASE.
