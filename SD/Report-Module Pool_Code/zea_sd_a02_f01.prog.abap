...
FORM F4_HELP .
  ...
  DATA : BEGIN OF LT_MATNR OCCURS 0,
           MATNR   TYPE ZEA_MMT050-MATNR,
           MAKTX   TYPE ZEA_MMT020-MAKTX,
           MATCOST TYPE ZEA_MMT050-MATCOST,
           WAERS   TYPE ZEA_MMT050-WAERS1,
*           NETPR   TYPE ZEA_SDT090-NETPR,
  ...
  CLEAR LS_FIELD.
  LS_FIELD-FIELDNAME = 'MATCOST'.
  LS_FIELD-INTLEN = 20.
  LS_FIELD-LENG = 20.
  LS_FIELD-OUTPUTLEN = 20.
  LS_FIELD-REPTEXT = '자재 단가'.
  APPEND LS_FIELD TO LT_FIELDS.
...
*     DYNPFLD_MAPPING = LT_MAP
  ...
  IF SY-SUBRC EQ 0.
    ...
    IF SY-SUBRC EQ 0.
      ZEA_MMT050-MATNR = LS_RETURN_TAB-FIELDVAL.

      READ TABLE LT_MATNR WITH KEY MATNR = ZEA_MMT050-MATNR BINARY SEARCH.
      IF SY-SUBRC EQ 0.
        ZEA_MMT050-MATNR        = LT_MATNR-MATNR.
        ZEA_MMT020-MAKTX        = LT_MATNR-MAKTX.
        ZEA_MMT050-MATCOST      = LT_MATNR-MATCOST.
        ZEA_SDT090-NETPR        = LT_MATNR-MATCOST * ( 17 / 10 ).
        ZEA_MMT050-WAERS1       = LT_MATNR-WAERS.
...
*  MOVE-CORRESPONDING ZEA_MMT050 TO GS_DISPLAY.
*  MOVE-CORRESPONDING ZEA_MMT020 TO GS_DISPLAY.

  GS_DISPLAY-MATNR = ZEA_MMT050-MATNR.
  GS_DISPLAY-MAKTX = ZEA_MMT020-MAKTX.
*    GS_DISPLAY-MATCOST = ZEA_MMT050-MATCOST.
  GS_DISPLAY-NETPR = ZEA_SDT090-NETPR.
  GS_DISPLAY-WAERS = ZEA_MMT050-WAERS1.
...
*    ENDIF.
*  ENDLOOP.
  ZEA_SDT090-MATNR = ZEA_MMT050-MATNR.
  ZEA_SDT090-NETPR = ZEA_MMT050-MATCOST * ( 17 / 10 ).
  ZEA_SDT090-WAERS = ZEA_MMT050-WAERS1.
