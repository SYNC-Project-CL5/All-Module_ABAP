class YCL_YE23_EX01_FCL_MPC definition
  public
...
CLASS YCL_YE23_EX01_FCL_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'YE23_EX01_FCL_SRV' ).
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            iv_association_name = 'Asso_Carrier_Connection' "#EC NOTEXT
                            iv_left_type        = 'Carrier' "#EC NOTEXT
                            iv_right_type       = 'Connection' "#EC NOTEXT
                            iv_right_card       = 'M' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - Asso_Carrier_Connection
lo_ref_constraint = lo_association->create_ref_constraint( ).
lo_ref_constraint->add_property( iv_principal_property = 'Carrid'   iv_dependent_property = 'Carrid' ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'Asso_Carrier_ConnectionSet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'CarrierSet'              "#EC NOTEXT
                                              iv_right_entity_set_name = 'ConnectionSet'             "#EC NOTEXT
                                              iv_association_name      = 'Asso_Carrier_Connection' ).                                 "#EC NOTEXT
...
* Navigation Properties for entity - Carrier
lo_entity_type = model->get_entity_type( iv_entity_name = 'Carrier' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'toConnection' "#EC NOTEXT
                                                              iv_abap_fieldname = 'TOCONNECTION' "#EC NOTEXT
                                                              iv_association_name = 'Asso_Carrier_Connection' ). "#EC NOTEXT
  endmethod.
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20240508012220'.                  "#EC NOTEXT
