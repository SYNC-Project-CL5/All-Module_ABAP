*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZEA_PPV02
*   generation date: 2024.05.11 at 01:10:52
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZEA_PPV02           .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZEA_PPV02'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZEA_PPV02_EXTRACT
TOTAL = ZEA_PPV02_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZEA_PPV02'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZEA_PPV02-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZEA_PPV02_EXTRACT
TOTAL = ZEA_PPV02_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZEA_PPV02-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZEA_PPV02'
...
TOTAL = ZEA_PPV02_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZEA_PPV02-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZEA_PPV02-UPD_FLAG NE SPACE.
