...
* 변환하는 과정이 필요하다.
  LOOP AT GT_EXCEL INTO GS_EXCEL.
    ...
    ON CHANGE OF GS_EXCEL-BOMID.
      ...
      GS_STKO-BOMID = ZEA_STKO-BOMID.
      GS_STKO-WERKS = GS_EXCEL-WERKS.
      GS_STKO-MATNR = GS_EXCEL-MATNR_HEADER.
      REPLACE ALL OCCURRENCES OF ',' IN GS_EXCEL-MENGE_HEADER WITH ''.
      GS_STKO-MENGE = GS_EXCEL-MENGE_HEADER.
      GS_STKO-MEINS = GS_EXCEL-MEINS_HEADER.
      GS_STKO-ERDAT = SY-DATUM.
      GS_STKO-ERZET = SY-UZEIT.
      GS_STKO-ERNAM = SY-UNAME.
      APPEND GS_STKO TO GT_STKO.
    ...
    GS_STPO-BOMID    = ZEA_STKO-BOMID.
    GS_STPO-BOMINDEX = LV_COUNT * 10.
    GS_STPO-MATNR    = GS_EXCEL-MATNR_ITEM.
    GS_STPO-MENGE    = GS_EXCEL-MENGE_ITEM.
    GS_STPO-MEINS    = GS_EXCEL-MEINS_ITEM.
