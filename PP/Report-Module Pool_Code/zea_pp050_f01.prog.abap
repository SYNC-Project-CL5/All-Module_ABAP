...
*    ON B~WERKS EQ A~WERKS.
  ...
  SORT GT_ZEA_T001W BY BUKRS WERKS MATNR.
*    B~MATNR EQ A~MATNR
...
*    GS_ZEA_T001W-TOTAL = GS_ZEA_T001W-PLANQTY1 + GS_ZEA_T001W-PLANQTY2 + GS_ZEA_T001W-PLANQTY3.
...
FORM GET_SBOOK USING PV_NODE_KEY.
  ...
  READ TABLE GT_ZEA_T001W INTO GS_ZEA_T001W WITH KEY MAKTX = GS_NODE-TEXT
                                                     WERKS = GS_NODE-RELATKEY.
...
**     AND MATNR = GS_ZEA_PPT010-MATNR.
  ...
  SELECT A~PLANID A~PLANQTY1 A~PLANQTY2 A~PLANQTY3 A~PLANQTY4
         A~PLANQTY5 A~PLANQTY6 A~PLANQTY7 A~PLANQTY8
         A~PLANQTY9 A~PLANQTY10 A~PLANQTY11 A~PLANQTY12 A~MEINS A~LOEKZ
    INTO CORRESPONDING FIELDS OF TABLE GT_ZEA_PPT010
  ...
  LOOP AT GT_ZEA_PPT010 INTO GS_ZEA_PPT010.

    GS_ZEA_PPT010-TOTAL =
    GS_ZEA_PPT010-PLANQTY1 + GS_ZEA_PPT010-PLANQTY2 +
    GS_ZEA_PPT010-PLANQTY3 + GS_ZEA_PPT010-PLANQTY4 +
    GS_ZEA_PPT010-PLANQTY5 + GS_ZEA_PPT010-PLANQTY6 +
    GS_ZEA_PPT010-PLANQTY7 + GS_ZEA_PPT010-PLANQTY8 +
    GS_ZEA_PPT010-PLANQTY9 + GS_ZEA_PPT010-PLANQTY10 +
    GS_ZEA_PPT010-PLANQTY11 + GS_ZEA_PPT010-PLANQTY12.

    MODIFY GT_ZEA_PPT010 FROM GS_ZEA_PPT010 INDEX SY-TABIX.
